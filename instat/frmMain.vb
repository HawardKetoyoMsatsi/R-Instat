...
Public Class frmMain
    ...
    Private Sub mnuStructuredCircularOtherRosePlotsPercentileRose_Click(sender As Object, e As EventArgs) Handles mnuStructuredCircularOtherRosePlotsPercentileRose.Click
